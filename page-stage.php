    ...
    <div class="container">
      <section class="block">
          <div class="block_body">
            <h2 class="block_body_title">公演情報</h2>
<!--             <div class="stageInfo">
              <div class="stage">
                <div class="stageReaflet">
                <img src="images/leaflet05.jpg" alt="ALT公演情報">
                </div>
                <p>○○公演</p>
                <h3>公演名</h3>
                <p>日程</p>
            ...
            <!-- とりあえず -->
            <div class="card mb-3">
            <div class="row no-gutters cell-size">
              <div class="col-md-2 stageImg">
                <a href="images/leaflet05.jpg" data-lightbox="sample" data-title="のぞきみ公演">
                <img src="images/leaflet05s.jpg" class="card-img" alt="ALT公演情報"></a>
              </div>
              <div class="col-md-10">
                <div class="col-md-8y stageDetail">
                  <p>○○公演</p>
                  <h5 class="card-title">公演名</h5>
                  <p class="card-text">日程</p>
                  <p class="card-text">会場 最寄り駅: ○○駅</p>
              </div><!-- /.col-md-8 -->
            </div><!-- /.col-md-8 -->
          </div><!-- /.row no-gutters -->
          </div><!-- /.card mb-3 -->
            ...
            <div class="row no-gutters cell-size">
              ...
              <div class="col-md-10">
                <div class="col-md-8y stageDetail">
                  ...
                  <h5 class="card-title">公演名</h5>
                  <p class="card-text">日程</p>
                  <p class="card-text">会場名</p>
                  <p class="card-text">最寄り駅: ○○駅</p>
              </div><!-- /.col-md-8 -->
            </div><!-- /.col-md-8 -->
          </div><!-- /.row no-gutters -->
          </div><!-- /.card mb-3 -->
